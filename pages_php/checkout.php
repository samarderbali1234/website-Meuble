...
<html lang="zxx">
   ...
   <body>
                  ...
                  <ul class="navbar-nav ">
                     ...
                     <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="nav-link" href="salon.php">Salons</a>
                                <a class="nav-link " href="canape.php">Canapés</a>
                                <a class="nav-link " href="rideau.php">Rideaux</a>
                        </div>
                     </li>
                     <li class="nav-item">
      ...
      <!-- //footer -->
      <!-- Modal 1-->  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
