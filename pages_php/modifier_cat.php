...
<?php } ?>
      ...
      <div class="modal-body">
                  ...
                  <h4>Donner le code de la catégorie <br>Et remplir les champs à modifier</h4>
                   ...
                   <table>
                           ...
                           <tr> <td>  <div class="styled-input" width="200">
                                 <input type="text" placeholder="Description" name="descrp">
                              </div></td>
            ...
            if(isset($_POST['b1'])){
               //if(isset($_POST['desig'])){
                  ...
                  $sql="update categorie set NOM= '$nom' where code = '$code'";

                  $query = mysqli_query($connection,$sql);
                  $sql="select * from categorie where NOM='$nom' and code='$code'";
                  $query = mysqli_query($connection,$sql);
                  $rows = mysqli_num_rows($query);
                  if($rows==1){
                     echo '<script>
                           alert("Nom modifiée avec succès");
                           </script>';
                     //header("location: index.php");
                  }
                  else{
                     echo '<script>
                           alert("Modification du nom à échouer \nveuillez reéssayer");
                           </script>';
                    }
               ...
               if(isset($_POST['b2'])){
                  ...
                  // SQL query to fetch information of registerd users and finds user match.
                  $sql="update categorie set description = '$descrp' where code = '$code'";

                  $query = mysqli_query($connection,$sql);
                  $sql="select * from categorie where description='$descrp' and code='$code'";
                  $query = mysqli_query($connection,$sql);
                  $rows = mysqli_num_rows($query);
                  if($rows==1){
                     echo '<script>
                           alert("Déscription modifiée avec succès");
                           </script>';
                     //header("location: index.php");
                  }
                  else{
                     echo '<script>
                           alert("Modification de la déscription à échouer \nveuillez reéssayer");
                           </script>';
                    }
                  mysqli_close($connection); // Closing Connection
               }
