               ...
               <div class="hedder-up row">
                  ...
                  <div class="col-lg-5 col-md-6 search-right">
                     <div class="form-inline my-lg-0" method="post">
                        ...
                        <span class="fas fa-search" style="background-color: #ECECEC; color: #000000;"></span>
                        </a>
                        </button>
...
<?php } ?>
      ...
      <div class="modal-body">
                  ...
                  <h4>Donner la référence du produit à supprimer</h4>
                           <form action="#" method="post">
                           <div class="fields-grid" >
                              <div class="styled-input" width="200">
                                 <input type="text" placeholder="Référence" name="ref" >
                              </div>   
              ...
              /* if(isset($_POST['desig'])){
                  ...
                  if($rows2==0){
                     echo '<script>
                           alert("Pas de produit ayant ces caractéristiques!");
                           </script>';
                     $_POST['desig']=null;
                     $_POST['img']=null;
                  }
                     ...
                     $sql="delete from produit where designation='$desig' && refImage='$img'";
                     $query = mysqli_query($connection,$sql);
                     $sql="select * from produit where designation='$desig' and refImage='$img'";
                     $query = mysqli_query($connection,$sql);
