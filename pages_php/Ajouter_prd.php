...
<?php } ?>
      ...
      <div class="modal-body">
                  <div class="register-form" align="center"  id="div_recherche">
                           ...
                           <div class="fields-grid" >
                              <div class="styled-input" width="200">
                                 <input type="text" placeholder="Désignation" name="desig" required="">
                              </div>
                              <div class="styled-input" width="200">
                                 <input type="text" placeholder="quantité en stock" name="qte" required="">
                              </div>
                              <div class="styled-input" width="200">
                                 <input type="text" placeholder="prix" name="prix" required="">
                              </div>
                              <div class="styled-input" width="200">
                                 <input type="text" placeholder="disponible ou non ?" name="disp" required="">
                              </div>
                              <div class="styled-input" width="200">
                                 <input type="text" placeholder="promotion" name="promo" required="">
                              </div>
                              <div class="styled-input" width="200">
                                 <input type="text" placeholder="src de l'image" name="img" required="">
                              </div>
                              <div class="styled-input" width="200">
                                 <input type="text" placeholder="code catégorie" name="cat_code" required="">
                              </div>      
                              <button type="submit" class="btn subscrib-btnn" >Ajouter</button>
               ...
               if(isset($_POST['desig'])){
                  ...
                  $sql="insert into produit (designation,qte,prix,disponibilite,promotion,refImage,codecateg) values ('$desig','$qte','$prix','$disp','$promo','$img','$cat_code')";
                  $query = mysqli_query($connection,$sql);
                  $sql="select * from produit where designation='$desig' and refImage='$img'";
                  $query = mysqli_query($connection,$sql);
                  $rows = mysqli_num_rows($query);
                  if($rows!=0){
                     echo '<script>
                           alert("insertion établie avec succès");
                           </script>';
                     //header("location: index.php");
                  }
                  else{
                     echo '<script>
                           alert("inserton échouée \nveuillez recommencer");
                           </script>';
                    }
